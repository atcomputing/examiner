...
public class Frustum
{
        ...
        public boolean pointX(float x, float z)
        {
        	for( int p = 0; p < 2; p++ )
            {
                    if( frustum[ p ][ 0 ] * x + frustum[ p ][ 2 ] * z
                                    + frustum[ p ][ 3 ] <= 0 )
                    {
                            return false;
                    }
        ...
        public boolean pointY(float y, float z)
        {
        	for( int p = 2; p < 4; p++ )
            {
                    if( frustum[ p ][ 1 ] * y + frustum[ p ][ 2 ] * z
                                    + frustum[ p ][ 3 ] <= 0 )
                    {
                            return false;
                    }
        ...
        public float getWorldCoordinateBottom( float z ) {
        	return (- frustum[ 2 ][ 3 ] - frustum[ 2 ][ 2 ]*z) /frustum[ 2 ][ 1 ];
        }
        
        public float getWorldCoordinateTop( float z ) {
        	return (- frustum[ 3 ][ 3 ] - frustum[ 3 ][ 2 ]*z)/frustum[ 3 ][ 1 ];
        }
        
        public float getWorldCoordinateLeft( float z ) {
        	return (- frustum[ 1 ][ 3 ] - frustum[ 1 ][ 2 ]*z)/frustum[ 1 ][ 0 ];
        }
        
        public float getWorldCoordinateRight( float z ) {
        	return (- frustum[ 0 ][ 3 ] - frustum[ 0 ][ 2 ]*z)/frustum[ 0 ][ 0 ];
        }
